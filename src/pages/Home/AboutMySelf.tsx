...
export const AboutMySelf: FC = () => (
  <div className="flex justify-between items-center">
    <div className="max-w-[644px] w-full">
      <Heading
        className="mt-4.5 capitalize text-[60px] leading-[68px]"
        tagHeading={TagsHeading.H2}
      >
        {HEADING}
      </Heading>
      <p className="mt-6 text-xl leading-26">{DESCRIPTION}</p>
      {/* CHANGE - add constant for name file */}
      <a href="." download="Resume of Oleksandr Myronchuk.pdf">
        <Button className="mt-9.5 capitalize text-xl font-medium">
          {DOWNLOAD_RESUME_BUTTON_NAME}
    ...
    <img
      className="w-[450px] h-[450px] ml-28 rounded-full shadow-lining-lighter-blue"
      src={PROFILE_IMG.SRC}
      alt={PROFILE_IMG.ALT_TEXT}
    />
  </div>
