  ...
  return (
    <header>
      <nav className="flex justify-end sm:mr-15">
        <BurgetButton
          className="sm:hidden my-5 mx-4.5 p-2"
          setIsOpen={setIsOpenMenu}
        />
        <ul
          className={cn(
            "absolute sm:static top-17.5 -translate-y-full sm:translate-y-0 flex-col items-center sm:flex-row flex w-full sm:w-auto h-screen-1/2 sm:h-auto py-7 invisible sm:visible transition ease-in-out duration-200",
            {
